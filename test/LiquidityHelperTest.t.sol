...
contract LiquidityHelperTest is DSTest, ILiquidityHelper {
  ...
  function setUp() public {
    ...
    helper = new LiquidityHelper(alchemica, pairAddresses, qRouter, GHST, mSig);
  ...
  function testBatchProvideAndWithdrawLiquidity() public {
    ...
    args[0] = AddLiquidityArgs(GHST, alchemica[0], 10e18, 100e18, 0, 0);
    args[1] = AddLiquidityArgs(GHST, alchemica[1], 10e18, 100e18, 0, 0);
    args[2] = AddLiquidityArgs(GHST, alchemica[2], 10e18, 100e18, 0, 0);
    args[3] = AddLiquidityArgs(GHST, alchemica[3], 10e18, 100e18, 0, 0);
    ...
    uint256 availAlpha = IERC20(pairAddresses[2]).balanceOf(address(helper));
